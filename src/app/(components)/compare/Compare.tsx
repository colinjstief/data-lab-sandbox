    ...
    <div className="flex p-5 gap-4">
      <div className="flex flex-col flex-1 gap-4">
        {Object.values(datasets).map((dataset) => {
          return (
            <div key={dataset.id} className="flex gap-4">
              <div className="w-[325px] p-3">
      ...
      <button
        className="hidden md:block bg-gray-200 px-5 h-full rounded-[10px] shadow hover:shadow-lg hover:bg-gray-300"
